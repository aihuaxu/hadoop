...
import org.apache.hadoop.hdfs.protocol.proto.ClientNamenodeProtocolProtos.GetRemoteFileSystemRequestProto;
import org.apache.hadoop.hdfs.protocol.proto.ClientNamenodeProtocolProtos.GetRemoteFileSystemResponseProto;
...
import org.apache.hadoop.hdfs.protocol.proto.ClientNamenodeProtocolProtos.RemoteFileSystemConfigEntryProto;
...
public class ClientNamenodeProtocolServerSideTranslatorPB implements
   ...
   */
  @Override
  public GetRemoteFileSystemResponseProto getRemoteFileSystem(RpcController controller,
                                                          GetRemoteFileSystemRequestProto req) throws ServiceException {
    try {
      ResolveResult resolveResult = server.getRemoteFileSystem(req.getSrcPath());
      List<String> resolvedPathStrs = PBHelperClient.convertResolvedPaths(resolveResult.getResolvedPaths());
      List<RemoteFileSystemConfigEntryProto> confEntries = PBHelperClient.convertConfEntries(resolveResult.getConf());
      GetRemoteFileSystemResponseProto.Builder builder = GetRemoteFileSystemResponseProto.newBuilder();
      builder.addAllResolvedPaths(resolvedPathStrs).addAllConfigEntries(confEntries);
      return builder.build();
    } catch (IOException e) {
      throw new ServiceException(e);
    }
