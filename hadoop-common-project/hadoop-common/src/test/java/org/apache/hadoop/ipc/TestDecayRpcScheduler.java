...
public class TestDecayRpcScheduler {
  ...
  public void testDecay() throws Exception {
    Configuration conf = new Configuration();
    conf.set("ipc.11." + DecayRpcScheduler.IPC_FCQ_DECAYSCHEDULER_PERIOD_KEY, "999999999"); // Never
    conf.set("ipc.11." + DecayRpcScheduler.IPC_FCQ_DECAYSCHEDULER_FACTOR_KEY, "0.5");
  ...
  public void testPeriodic() throws InterruptedException {
    Configuration conf = new Configuration();
    conf.set("ipc.15." + DecayRpcScheduler.IPC_FCQ_DECAYSCHEDULER_PERIOD_KEY, "10");
    conf.set("ipc.15." + DecayRpcScheduler.IPC_FCQ_DECAYSCHEDULER_FACTOR_KEY, "0.5");
    scheduler = new DecayRpcScheduler(1, "ipc.15", conf);
