...
public class TestConnectionManager {
  ...
  public void testCleanup() throws Exception {
    ...
    ConnectionPool pool1 = new ConnectionPool(
        conf, TEST_NS, TEST_NN_ADDRESS, TEST_USER1, 0, 10, 0.5f);
    ...
    ConnectionPool pool2 = new ConnectionPool(
        conf, TEST_NS, TEST_NN_ADDRESS, TEST_USER2, 0, 10, 0.5f);
    ...
    ConnectionPool pool3 = new ConnectionPool(
        conf, TEST_NS, TEST_NN_ADDRESS, TEST_USER3, 2, 10, 0.5f);
  ...
  public void testConfigureConnectionActiveRatio() throws IOException {
    ...
    tmpConnManager.getConnection(TEST_USER1, TEST_NS, TEST_NN_ADDRESS);
