...
public class PBHelperClient {
  ...
  public static BadDataNodeInfo[] convertBadDataNodeInfoArray(
          MarkBadDataNodesRequestProto request) {
    BadDataNodeInfo[] nodesInfo = new BadDataNodeInfo[request.getNodesCount()];
    int i = 0;
