...
public class TestObserverNode {
  ...
  public void testObserverNodeSafeModeWithBlockLocations() throws Exception {
    ...
    Answer<LocatedBlocks> ans = new Answer<LocatedBlocks>() {
      @Override
    ...
    Mockito.doAnswer(ans).when(bmSpy).createLocatedBlocks(
        Matchers.<BlockInfo[]>any(),
        anyLong(), anyBoolean(), anyLong(), anyLong(), anyBoolean(),
        anyBoolean(), Matchers.<FileEncryptionInfo>any());
