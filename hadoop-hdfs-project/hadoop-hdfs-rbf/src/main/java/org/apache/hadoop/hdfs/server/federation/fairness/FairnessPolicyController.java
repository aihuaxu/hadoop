...
public interface FairnessPolicyController {

  /**
   * Algorithm to assign handlers to configured name services. Implementations
   * can choose to use configuration object to read configs specific to those
   * implementations. This is invoked at start-up and as part of constructor.
   *
   * @param conf Configuration.
   * @throws PermitAllocationException Throws exception if allocation of
   *         handlers to permits could not be successful at start-up.
   */
  void assignHandlersToNameservices(Configuration conf)
   ...
   * @throws NoPermitAvailableException Throws exception if no permission is
   *         either available or can't be granted for other reasons.
   */
  void acquirePermit(String nsId)
