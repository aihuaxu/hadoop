...
public class DFSUtilClient {
  ...
  public static Collection<String> getNameNodeIdsExcludingObservers(
    ...
    if (!allNNIds.containsAll(observerNNIds)) {
      throw new IllegalArgumentException(
          "Observer NameNodes should be part of all NameNodes");
    }
   ...
   *
   * @param conf configuration
   * @return list of InetSocketAddresses, not including those of observer NNs.
   */
  ...
  static Map<String, Map<String, InetSocketAddress>> getAddresses(
    ...
    return getAddressesInternal(conf, defaultAddress, NameNodeType.ACTIVE_STANDBY, keys);
  }
  ...
  public static Path getHomeDirectory(Configuration conf,
    ...
    return new org.apache.hadoop.fs.Path(userHomePrefix + "/" + userName);
  }
}
